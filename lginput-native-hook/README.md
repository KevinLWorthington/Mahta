...
Installed and configured using CLI, or directly on the TV with the
[Mahta webOS app](webos-app/README.md) — a remote-friendly UI that
installs the hook, shows button codes, lists installed apps, and remaps
buttons on an interactive picture of the remote.
