...
This produces `dist/org.kevinlworthington.lginputhook_x.x.x_all.ipk`.
...
```bash
scp dist/org.kevinlworthington.lginputhook_x.x.x_all.ipk root@<TV_IP>:/tmp/
ssh root@<TV_IP> "luna-send -i 'luna://com.webos.appInstallService/dev/install' \
  '{\"id\":\"org.kevinlworthington.lginputhook\",\"ipkUrl\":\"/tmp/org.kevinlworthington.lginputhook_x.x.x_all.ipk\",\"subscribe\":true}'"
```
